public class Cadete extends Empleado{
    ...
    public Cadete(String nombre, int diasAusente, String desempeñoBuenoMedioMalo) {
        super(nombre, diasAusente, desempeñoBuenoMedioMalo);
        this.sueldoNeto=1500;
    ...
    public void fijarBonosYSueldo(){
        ...
        this.bonoPorPresentismo=bonoPorPresentismo;
        System.out.println(this.getNombre()+" falto "+this.getDiasAusente()+" vez al trabajo y obtuvo "+this.bonoPorPresentismo+"$ de bono por presentismo");
